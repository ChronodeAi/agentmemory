...
function readConfigFile(path) {
	...
	try {
		const parsed = (0, import_dist.parse)(readFileSync(path, "utf8"));
...
function loadAgentmemoryEnvironment() {
	...
	if (existsSync(envPath)) try {
		fileEnv = (0, import_main.parse)(readFileSync(envPath));
	} catch {
		fileEnv = {};
	}
...
//#endregion
export { normalizedProjectPath as a, loadAgentmemoryEnvironment as i, projectAuthHeaders as n, resolveProjectConfig as o, isProjectPathExcluded as r, contextAcknowledgementSecret as t };
