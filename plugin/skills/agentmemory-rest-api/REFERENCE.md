...
| POST | `/agentmemory/context-acknowledge` |
| POST | `/agentmemory/context-packet` |
...
| GET | `/agentmemory/project-health` |
| GET | `/agentmemory/promotion-candidates` |
| POST | `/agentmemory/promotion-decide` |
