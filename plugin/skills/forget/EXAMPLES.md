...
```json
memory_smart_search { "project": "github.com/example/repository", "query": "api key", "limit": 20 }
```
...
```json
memory_governance_delete { "project": "github.com/example/repository", "memoryIds": "abc12345", "reason": "user privacy request" }
```
...
```json
memory_smart_search { "project": "github.com/example/repository", "query": "spike prototype throwaway", "limit": 20 }
```
