...
- **max_parallel_subagents**: 4 (operator override)
- **max_parallel_ralph_loops**: 2 (operator override)
- **max_parallel_mc_missions**: 4 (operator override)

*Rationale*: Canary cap for Agentmemory hook and memory-pressure validation across Codex and Claude; raise only after concurrent load tests pass.
...
- Configured providers: codex, claude
...
- Canonical tracker: `origin` (github; https://github.com/ChronodeAi/agentmemory.git)
